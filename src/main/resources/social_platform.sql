...
insert into `user` (`id`, `username`, `nickname`, `password`, `avatar`, `bio`, `gender`, `authority_id`, `enabled`)
values (1, 'li', '管理员',
        '{bcrypt}$2a$10$Zzd1nV8xK0wYC3337/SCD.hH39iDgWUzDbBZ5ew5AhMrILnm.8Eqm',
        'https://111.com', '这是管理员', 0,  2, 1);
...
insert into `authority` (`id`, `authority`) values (3, 'REVIEW'); # 审核员
